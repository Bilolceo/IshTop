    ...
    >
      ...
      <div className="mt-6 flex items-center justify-between gap-4">
        <button
          ...
          onClick={() => go(-1)}
          aria-label="Previous"
          className="focus-ring grid h-11 w-11 place-items-center rounded-full border border-surface-200 bg-white text-surface-700 transition hover:border-violet-300 dark:border-white/10 dark:bg-white/[0.04] dark:text-white/80"
        >
