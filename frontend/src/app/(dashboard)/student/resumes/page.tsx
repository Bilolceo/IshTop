    ...
    >
      ...
      >
        ...
        <Button
          ...
          className="bg-gradient-to-r from-brand-500 to-violet-600 shadow-lg shadow-brand-500/25 hover:shadow-brand-500/40"
        >
          ...
          <Card className="py-16">
            <CardContent className="flex flex-col items-center justify-center text-center">
              ...
              {!searchQuery && statusFilter === "all" && (
                <Button
                  onClick={() => setShowCreateDialog(true)}
                  className="mt-6 bg-gradient-to-r from-brand-500 to-violet-600"
                >
                  <Plus className="mr-2 h-4 w-4" />
                  {isRu
                  ...
                  <div className="mb-4 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      {resume.ai_generated && (
                        <Badge
                          variant="default"
                          className="gap-1 bg-gradient-to-r from-brand-500 to-violet-600"
                        >
          ...
          <div className="mt-4 space-y-4">
            ...
            >
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-500 to-violet-600 p-6 text-white cursor-pointer"
              >
