      ...
      >
        <div>
          <h1 className="flex items-center gap-2 text-2xl font-bold text-surface-900">
            <BookmarkCheck className="h-6 w-6 text-brand-600" />
            Saqlangan ishlar
          </h1>
            ...
            {filtered.map((job, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative flex flex-col rounded-2xl border border-surface-200 bg-white p-5 shadow-sm transition-all hover:border-brand-200 hover:shadow-md dark:border-surface-700 dark:bg-surface-800 dark:hover:border-brand-700"
                >
                  {/* Remove button */}
                  <button
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-brand-500 to-violet-600 text-sm font-bold text-white">
                      {companyLetter}
                    </div>
                  ...
                  <Link href={`/student/jobs/${job.id}`}>
                    <h3 className="mt-3 text-base font-bold text-surface-900 hover:text-brand-600 transition-colors">
                      {job.title}
                    </h3>
                  </Link>
