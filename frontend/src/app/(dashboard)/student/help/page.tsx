        ...
        {items.map((item) => {
          ...
          const content = (
            <Card className="h-full rounded-2xl border-surface-200 transition-all hover:-translate-y-0.5 hover:shadow-md dark:border-surface-700">
              <CardHeader>
                <div className="mb-2 flex h-10 w-10 items-center justify-center rounded-xl bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300">
              ...
              <CardContent>
                <Button className="w-full justify-between bg-gradient-to-r from-purple-500 to-indigo-600">
                  {item.label}
