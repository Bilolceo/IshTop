            ...
            <div className="h-72">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={dailyChart}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Line isAnimationActive={false} type="monotone" dataKey="views" stroke="#a08de0" strokeWidth={2} dot={false} />
                  <Line isAnimationActive={false} type="monotone" dataKey="applications" stroke="#6F9BF0" strokeWidth={2} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          )}
