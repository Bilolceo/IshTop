    ...
    <div className="space-y-6">
      ...
      >
        ...
        <StatsCard
          ...
          icon={FileText}
          color="bg-brand-100 dark:bg-brand-500/20 text-brand-600"
        />
        <StatsCard
                ...
                <div className="space-y-4">
                  {jobs.slice(0, 4).map((job: Job, index: number) => (
                    <motion.div
                      ...
                      className="flex items-center justify-between rounded-xl border border-surface-200 p-4 transition-all hover:border-brand-200 hover:bg-brand-50/50 dark:border-surface-700 dark:hover:border-brand-500/30 dark:hover:bg-brand-500/5"
                    >
      ...
      >
        <Card className="bg-gradient-to-br from-brand-50 to-violet-50 dark:from-brand-900/20 dark:to-violet-900/20 border-brand-200 dark:border-brand-500/30">
          <CardContent className="flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-4">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-100 dark:bg-brand-500/20">
      ...
      >
        <Link href="/company/jobs/new">
          <Card className="cursor-pointer transition-all hover:border-brand-300 hover:shadow-lg">
            <CardContent className="flex items-center gap-4 pt-6">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-brand-100 text-brand-600 dark:bg-brand-500/20">
