 ...
 *
 * The job's own fields are the Uzbek text; `translations.ru` holds the Russian
 * version (backend jobs.translations). Switching the site to Russian used to
