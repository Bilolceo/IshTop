...
export const ru = {
  ...
  landing: {
    hero: {
      ...
      subtitle: "Для студентов, выпускников и junior-специалистов. Создавайте AI-резюме, находите стажировки и junior-вакансии, откликайтесь за минуты.",
  ...
  auth: {
    sidebar: {
      ...
      subtitle: "AI анализирует ваше резюме, подбирает подходящие вакансии и готовит отклик за минуты.",
      features: [
        "AI-генератор резюме",
  ...
  dashboard: {
    ...
    subtitle: "Что нового в вашей студенческой и junior-карьере сегодня",
