 ...
 *
 * Design System:
 * - Colors: Primary (Indigo), Secondary (Purple), Status colors
 * - Typography: Inter for headings/body, Fira Code for code
 * - Animations: Smooth transitions, page transitions
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "dot-pattern":
          "url(\"data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%236366F1' fill-opacity='0.1' fill-rule='evenodd'%3E%3Ccircle cx='3' cy='3' r='1.5'/%3E%3Ccircle cx='13' cy='13' r='1.5'/%3E%3C/g%3E%3C/svg%3E\")",
      },
